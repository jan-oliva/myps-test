...
class ActionColumn extends Column implements \ArrayAccess
{
	...
	{
		if ($need == TRUE) {
			throw new \InvalidStateException("PM\DataGrid\Columns\ActionColumn cannot has filter.");
		}
		return NULL;
	}
	...
	final public function offsetSet($name, $component)
	{
		...
		if (!$component instanceof IComponent) {
			throw new \InvalidArgumentException("PM\DataGrid\Columns\ActionColumn accepts only IComponent objects.");
		}
