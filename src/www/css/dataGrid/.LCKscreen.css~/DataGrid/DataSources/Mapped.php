...
namespace PM\DataGrid\DataSources;
...
abstract class Mapped extends DataSource
{
	...
	protected $aliasReverseMapping = array();

	public function setAliasReverseMapping(array $aliasReverseMapping)
	{
		$this->aliasReverseMapping = $aliasReverseMapping;
		return $this;
	}
