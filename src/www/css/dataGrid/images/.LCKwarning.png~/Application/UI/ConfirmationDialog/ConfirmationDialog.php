<?php
namespace PM\Nette\Application\UI\ConfirmationDialog;
 ...
 *
 *
 * Modified for nette version 2.0 alfa
 * 
 * Jan Oliva
 */
...
class ConfirmationDialog extends Control
{
	...
	const DIALOG_CLASS_CONFIRM_DIALOG ='confirm_dialog';
	const DIALOG_CLASS_STATIC_DIALOG ='static_dialog';
	 ...
	 * @param type $parent
	 * @param type $name
	 * @param \Nette\Http\ISessionStorage $session
	 */
	public function __construct($parent = NULL, $name = NULL, \Nette\Http\Session $session)
	{
		...
		$this->session = $session->getSection('ConfirmationDialog/tokens');
