...
use Nette, Nette\Utils\Html, PM\Datagrid, PM\DataGrid\Filters;
 ...
 */
abstract class Column extends /*Nette\ComponentContainer*/ Container implements IColumn
{
	...
	public function __construct($caption = NULL, $maxLength = NULL)
	{
		...
		$this->monitor('PM\DataGrid\DataGrid');
	}
	...
	{
		return $this->lookup('PM\DataGrid\DataGrid', $need);
	}
