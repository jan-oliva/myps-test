...
// links
$(document).on("click","table.datagrid a.datagrid-ajax", function (e) {
	$.get(this.href);
	e.preventDefault(e) ;
	//return false;
});
...
//form buttons
$(document).on("click","form.datagrid :submit", function (e) {
	 $(this).ajaxSubmit(e);
	 console.log(e);
	 e.preventDefault() ;
	//return false;
...
$(document).on("click","table.datagrid tr td:not(.checker)", function (e) {
